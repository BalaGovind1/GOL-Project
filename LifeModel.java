...
public class LifeModel extends Observable
{
    ...
    protected final int RIJEN ;
    protected final int KOLOMMEN ;
    ...
    public static String RIJENSIZE;

    public static String KOLOMMENSIZE;
    public LifeModel()
    {
        ...
        KOLOMMENSIZE = scanner6.nextLine();

        KOLOMMEN = Integer.parseInt(KOLOMMENSIZE);

        Scanner scanner5 = new Scanner(System.in);
        System.out.print("Enter Row Size: ");
        RIJENSIZE = scanner5.nextLine();

        RIJEN = Integer.parseInt(RIJENSIZE);
